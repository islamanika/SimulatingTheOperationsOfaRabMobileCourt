 ...
 * @author Hamida
 */
public class U7_View_Survey_ReportController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try{
            String fileName="User8_All_File//Submit_Survey_Report//November2023.txt";
    ...
    private void viewSurveyReportOnClick(ActionEvent event) {
        ...
        try{
            String fileName="User8_All_File//Submit_Survey_Report//"+month+year+".txt";
            File file=new File(fileName);
            if(!file.exists()){
