...
public class HirelawyerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        lawyercombo.getItems().addAll("Adv. Sharif","Adv. Kader");
        // TODO
        ...
        casedetailscol.setCellValueFactory(new PropertyValueFactory<HirelawyerDetails, String>("details"));
        ...
        lawyercol.setCellValueFactory(new PropertyValueFactory<HirelawyerDetails, String>("lawyername"));
        File f = null;
